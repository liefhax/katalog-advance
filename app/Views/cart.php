        ...
        <div class="row g-5">
            <div class="col-lg-8">
                ...
                <div class="card mb-3 shadow-sm border-0">
                    <div class="row g-0">
                        <div class="col-md-3">
                            <img src="<?= esc($item['image_url']) ?>" class="img-fluid rounded-start" alt="<?= esc($item['name']) ?>" style="height: 100%; object-fit: cover;">
                        </div>
                        <div class="col-md-9">
                            <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="d-grid">
                            <a href="#" class="btn btn-primary btn-lg">Lanjut ke Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
