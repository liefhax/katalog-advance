                ...
                <form action="/admin/products/update/<?= $product['id'] ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <label for="image_url" class="form-label">Ganti Gambar Produk</label>
                                <br>
                                <img src="/uploads/products/<?= esc($product['image_url']) ?>" alt="" class="mb-2" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px;">
                                <input class="form-control" type="file" id="image_url" name="image_url">
                                <small class="text-muted">Biarkan kosong jika tidak ingin ganti gambar. (Max 2MB)</small>
                            </div>
                            <div class="mb-3">
